...
<body>
    ...
    <div class="container-form">
        ...
        <form method="post">
            ...
            CEP:<br>
            <input type="text" name="cep" id="cep" maxlength="10" title="12.345-678"
                   placeholder="12.345-678" pattern="\d{2}.\d{3}-\d{3}"><br><br>

            Tipo de Endereço:<br>
            <input type="radio" name="endereco" id="endereco" value="1" disabled <?php echo ($endPrincipal == 1 ? "checked" : "")?>> Principal
            <input type="radio" name="endereco" id="endereco" value="0" disabled <?php echo ($endPrincipal == 0 ? "checked" : "")?>> Adicional<br><br>
            <input type="submit" class="btn-cadastra" value="Salvar" onclick="updateData()">
        </form>
    </div>
    <script src="script-altera.js"></script>
